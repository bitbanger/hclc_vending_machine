			...
			new Thread()
			{
				public void run()
				{
					...
					if (result.equals("Good"))
					{
						...
						parent.refreshItemPurchased(true, "<html><p>Thank you for purchasing " + controller.getPurchasedItem().getName() + "</p><p>Your remaining balance is " + U.formatMoney(controller.getBalance()) + "</p>");
						master.pack();
					}
					else
					{
