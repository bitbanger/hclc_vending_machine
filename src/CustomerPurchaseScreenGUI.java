			...
			new Thread()
			{
				public void run()
				{
					...
					if (result.equals("Good"))
					{
						...
						parent.refreshItemPurchased(true, "<html><p>Thank you for purchasing " + controller.getPurchasedItem().getName() + ". Your change is " + U.formatMoney(controller.getBalance()) + "</p>");
					}
					else
					{
